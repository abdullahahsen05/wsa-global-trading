...
export const navItems: NavItem[] = [
  ...
  { href: "/marketplace", label: "Marketplace", role: "TRADER", icon: BriefcaseBusiness },
  ...
  { href: "/admin/partners/withdrawals", label: "Partner Finance", role: "ADMIN", icon: WalletCards },
  { href: "/admin/marketplace", label: "Marketplace", role: "ADMIN", icon: BriefcaseBusiness },
  ...
  { href: "/partner/rebate", label: "Rebate", role: "PARTNER", icon: BadgeDollarSign },
  { href: "/partner/cpa", label: "CPA", role: "PARTNER", icon: BarChart3 },
  { href: "/partner/hybrid", label: "Hybrid", role: "PARTNER", icon: Repeat },
  { href: "/partner/wsa-commission", label: "WSA Commission %", role: "PARTNER", icon: BadgeDollarSign },
  { href: "/partner/wsa-payout", label: "WSA Payout", role: "PARTNER", icon: WalletCards },
